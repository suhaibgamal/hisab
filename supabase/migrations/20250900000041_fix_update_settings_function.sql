...
DROP FUNCTION IF EXISTS public.update_group_settings(uuid, text, text, text, integer, boolean, text, text, text);
DROP FUNCTION IF EXISTS public.update_group_settings(uuid, text, text, text, integer, boolean, text);
