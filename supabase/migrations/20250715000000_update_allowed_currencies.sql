-- Migration: Update allowed currencies in create_new_group
-- Date: 2025-07-15
...
BEGIN
    ...
    IF p_currency IS NULL OR p_currency NOT IN (
      'USD','EUR','SAR','EGP','GBP','AED','KWD','QAR','OMR','BHD','JOD','MAD','CHF','CAD','AUD','JPY','CNY','INR',
      'DZD','TND','LYD','SDG','LBP','SYP','IQD','MRU','DJF','KMF','SOS','YER'
    ) THEN
