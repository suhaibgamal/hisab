-- MIGRATION to fix the add_settlement function.
-- This makes the description optional.

create or replace function public.add_settlement(
  p_group_id uuid,
  p_to_user_id uuid,
  p_amount numeric,
  p_description text default 'Settlement' -- Make description optional with a default
)
returns uuid
language plpgsql
security definer
