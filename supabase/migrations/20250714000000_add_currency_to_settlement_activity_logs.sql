-- Migration: Add currency to settlement activity logs
-- Date: 2025-07-14

-- 1. Update add_settlement to log currency
...
-- 2. Update confirm_settlement to log currency
...
BEGIN
  ...
  SELECT currency INTO v_currency FROM groups WHERE id = v_settlement.group_id;
  IF v_currency IS NULL THEN
    v_currency := 'USD';
  END IF;
...
-- 3. Update reject_settlement to log currency
