...
CREATE POLICY "group_members_insert_policy" ON "public"."group_members" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND ("user_id" = "public"."get_current_user_id"())));



CREATE POLICY "group_members_select_policy" ON "public"."group_members" FOR SELECT USING ((("auth"."role"() = 'authenticated'::"text") AND ("user_id" = "public"."get_current_user_id"())));
...
CREATE POLICY "groups_create_policy" ON "public"."groups" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND ("manager_id" = "public"."get_current_user_id"())));



CREATE POLICY "groups_manage_policy" ON "public"."groups" FOR UPDATE USING (("manager_id" = "public"."get_current_user_id"())) WITH CHECK (("manager_id" = "public"."get_current_user_id"()));



CREATE POLICY "groups_view_policy" ON "public"."groups" FOR SELECT USING ((("auth"."role"() = 'authenticated'::"text") AND (("manager_id" = "public"."get_current_user_id"()) OR (EXISTS ( SELECT 1
   FROM "public"."group_members" "gm"
  WHERE (("gm"."group_id" = "groups"."id") AND ("gm"."user_id" = "public"."get_current_user_id"())))) OR ("password" IS NULL))));
