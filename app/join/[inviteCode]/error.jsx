...
export default function JoinGroupError({ error, reset }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      ...
      <h1 className="text-3xl font-bold mb-2">تعذر الانضمام للمجموعة</h1>
      <p className="mb-6 text-gray-400">
        رمز الدعوة غير صالح أو المجموعة غير متاحة أو حدث خطأ غير متوقع.
      </p>
      <Link
        href="/"
